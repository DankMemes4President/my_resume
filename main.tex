...
- Developed \textit{REST APIs} for BITS Pilani's annual events (BOSM, Oasis, Apogee) using \textit{Django REST Framework} and \textit{PostgreSQL}.

- Created internal tools using \textit{Django} for Registrations, Event, and Inventory management, driving revenues of \textbf{8 Lacs} and \textbf{40 Lacs} for BOSM and Oasis.
